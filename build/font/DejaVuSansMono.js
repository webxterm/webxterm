...
class DejaVuSansMono extends Font_1.Font {
    constructor() {
        super();
        this.fontSizes = {
...
exports.DejaVuSansMonoBold = DejaVuSansMonoBold;
class DejaVuSansMonoBoldOblique extends DejaVuSansMono {
    getFontName() {
        return "DejaVu Sans Mono Bold Oblique";
    }
}
exports.DejaVuSansMonoBoldOblique = DejaVuSansMonoBoldOblique;
class DejaVuSansMonoOblique extends DejaVuSansMono {
    getFontName() {
        return "DejaVu Sans Mono Oblique";
    }
}
exports.DejaVuSansMonoOblique = DejaVuSansMonoOblique;
