...
//     // private readonly _blockValues: string[] = [];
//     // private readonly _blockAttrs: string[] = [];
//     // private readonly _blockDisplaySizes: number[] = [];
//
//     // 是否为脏数据(未更新到元素中的数据)
...
//         this._cols = cols;
//
//         this._blocks = Array.from({length: cols}, ()=> " ");
//         // this._blockValues = Array.from({length: cols}, () => " ");
//         // this._blockAttrs = Array.from({length: cols}, () => " ");
...
//     //     if(CommonUtils.real_str_len(data) > 1){
